...
public:
	...
	static optional<UplaySaveMetaDataStorage> ReadMetaDataStorage(const path& savesPath);
	static bool UpdateMetaDataStorage(const path& storagePath, const UplaySaveMetaDataStorage& storage);
	...
	const path& storagePath)
{
	...
	if (fs)
	{
		UplaySaveMetaDataStorage data = json::parse(
